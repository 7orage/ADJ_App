...
export default function EquipierMessagingScreen({ onNavigate, profilADJ, onOuvrirProfilAdmin, messages = [], onEnvoyer, onOuvrir, photoMoi }) {
          ...
          return (
            <View key={msg.id} style={[styles.bubbleRow, isMoi ? styles.rowRight : styles.rowLeft]}>
              ...
              {isMoi && (
                <View style={styles.msgAvatar}>
                  {photoMoi
                    ? <Image source={{ uri: photoMoi }} style={styles.msgAvatarImg} />
                    : <Ionicons name="person" size={14} color={COULEUR} />
                  }
                </View>
              )}
...
const styles = StyleSheet.create({
  ...
  cardAvatar: { width: 50, height: 50, borderRadius: 25, backgroundColor: '#e0f2fe', borderWidth: 2, borderColor: COULEUR, alignItems: 'center', justifyContent: 'center' },
  cardText: { flex: 1 },
  ...
  msgAvatar: { width: 28, height: 28, borderRadius: 14, borderWidth: 1.5, borderColor: COULEUR, backgroundColor: '#e0f2fe', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', flexShrink: 0 },
  ...
  previewDoc: { width: 60, height: 60, borderRadius: 10, backgroundColor: '#e0f2fe', alignItems: 'center', justifyContent: 'center' },
  ...
  menuIcone: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#e0f2fe', alignItems: 'center', justifyContent: 'center' },
